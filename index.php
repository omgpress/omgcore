...
if ( ! class_exists( 'WP_Titan_1_0_12\App' ) ) {
	define( 'WP_Titan_1_0_12\ROOT_FILE', __FILE__ );
	define( 'WP_Titan_1_0_12\PRIORITY', 10 );
	define( 'WP_Titan_1_0_12\H_PRIORITY', 1 );
	define( 'WP_Titan_1_0_12\L_PRIORITY', 999999 );

	require_once __DIR__ . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR . 'autoload.php';
}

if ( ! function_exists( 'WP_Titan_1_0_12\wpt_is_debug_enabled' ) ) {
	function wpt_is_debug_enabled(): bool {
		return defined( 'WP_DEBUG' ) && WP_DEBUG;
	}
}

if ( ! function_exists( 'WP_Titan_1_0_12\wpt_generate_random_str' ) ) {
...
if ( ! function_exists( 'WP_Titan_1_0_12\wpt_die' ) ) {
