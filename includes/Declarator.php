 ...
 * In most cases we call declarator classes inside the application setup action (`app()->setup($callback)`), when the WordPress environment is fully loaded. But they can also be called earlier if necessary for the application logic. For example, it could be the database initialization, or other logic based on the activation and deactivation hooks, etc.\
